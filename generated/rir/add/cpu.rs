...
// Kernel: add (backend cpu, reduction serial).
        ...
        for row_v1 in 0..n_row {
            ...
            for plane_v2 in 0..n_plane {
                ...
                for batch_v3 in 0..n_batch {
                    let t_v4 = a.data[(batch_v3 * a.nb[3] + base_v7) / 4];
                    let t_v5 = b.data[(batch_v3 * b.nb[3] + base_v8) / 4];
                    let t_v6 = t_v4 + t_v5;
                    dst.data[(batch_v3 * dst.nb[3] + base_v9) / 4] = t_v6;
                }
            }
        }
    }
