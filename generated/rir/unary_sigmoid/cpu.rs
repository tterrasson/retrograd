...
// Kernel: unary_sigmoid (backend cpu, reduction serial).
        ...
        for row_v1 in 0..n_row {
            ...
            for plane_v2 in 0..n_plane {
                ...
                for batch_v3 in 0..n_batch {
                    let t_v6 = x.data[(batch_v3 * x.nb[3] + base_v11) / 4];
                    let t_v7 = c_v5 - t_v6;
                    let t_v8 = t_v7.exp();
                    let t_v9 = c_v4 + t_v8;
                    let t_v10 = c_v4 / t_v9;
                    dst.data[(batch_v3 * dst.nb[3] + base_v12) / 4] = t_v10;
                }
            }
        }
    }
