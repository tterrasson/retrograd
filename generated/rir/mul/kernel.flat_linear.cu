...
// Kernel: mul (backend cuda, reduction serial, scan serial, variante flat_linear).
...
static void rir_k_mul_flat_linear(
        const uint8_t * __restrict__ a,
        const uint8_t * __restrict__ b,
        uint8_t * __restrict__ dst,
        const rir_mul_flat_linear_params p)
{
...
extern "C" void rir_launch_mul_flat_linear(
    ...
    rir_mul_flat_linear_params p;
    std::memcpy(&p, params, sizeof p);
    rir_k_mul_flat_linear<<<dim3(grid[0], grid[1], grid[2]), dim3(256, 1, 1), 0, stream>>>(
